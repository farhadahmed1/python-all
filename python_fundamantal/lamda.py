...
senior_users = filter(lambda user: user['age']> 30 , users)
filter_users = list(senior_users)
# print(filter_users)
user_selection = map(lambda user:user["name"], filter_users) 
print(list(user_selection))


for data in filter_users:
    print(dict(data)["name"])